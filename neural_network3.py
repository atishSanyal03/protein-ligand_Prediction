...
from keras.layers import Input, Conv2D,MaxPooling3D,Flatten,Dense, Dropout, BatchNormalization
...
model.add(Conv2D(filters=32,kernel_size=3,padding='Same',data_format='channels_last',activation='relu', use_bias=True,input_shape=(10,20)))
#model.add(MaxPooling3D(pool_size=3))
#model.add(Dropout(0.5))


model.add(Conv2D(filters=64,kernel_size=3,padding='Same',data_format='channels_last', use_bias=True,activation='relu',kernel_regularizer=regularizers.l2(0.01),
                activity_regularizer=regularizers.l1(0.01)))

model.add(Conv2D(filters=128,kernel_size=3,padding='Same',data_format='channels_last', use_bias=True,activation='relu',kernel_regularizer=regularizers.l2(0.01),
                activity_regularizer=regularizers.l1(0.01)))
